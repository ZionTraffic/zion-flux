...
-- Drop and recreate kpi_overview_daily view with SECURITY INVOKER
DROP VIEW IF EXISTS public.kpi_overview_daily;
...
-- Drop and recreate v_qualificacao view with SECURITY INVOKER
DROP VIEW IF EXISTS public.v_qualificacao;
