    ...
    <Card className="p-4 md:p-6 glass border border-border/50 shadow-premium">
      <div className="space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4">
          ...
          <div className="p-4 rounded-xl glass border border-emerald-500/30 shadow-premium hover:shadow-xl transition-all duration-300 bg-emerald-500/5">
            <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-2xl font-bold text-emerald-600">
              {totaisPorStatus.enviados.toLocaleString('pt-BR')}
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              com sucesso
            </p>
          ...
          <div className="p-4 rounded-xl glass border border-red-500/30 shadow-premium hover:shadow-xl transition-all duration-300 bg-red-500/5">
            <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-2xl font-bold text-red-600">
              {totaisPorStatus.numeroInvalido.toLocaleString('pt-BR')}
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              números errados
            </p>
          ...
          <div className="p-4 rounded-xl glass border border-amber-500/30 shadow-premium hover:shadow-xl transition-all duration-300 bg-amber-500/5">
            <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-2xl font-bold text-amber-600">
              {totaisPorStatus.suspensao.toLocaleString('pt-BR')}
            </p>
            <p className="text-xs text-muted-foreground mt-1">
              conta suspensa
            </p>
