  ...
  ({ className, items, activeItem, onItemClick }, ref) => {
    ...
    return (
      ...
      >
        ...
        />
        <ul className="flex items-center gap-1 xl:gap-2 relative z-10">
          {items.map((item) => {
              ...
              <motion.li key={item.label} className="relative">
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      className={cn(
                        "flex items-center gap-2 px-2 xl:px-4 py-1.5 xl:py-2 relative z-10 bg-transparent transition-colors rounded-xl",
                        isActive
                          ? "text-foreground"
                    ...
                    <motion.div
                      className={cn(
                        "flex items-center gap-2 px-2 xl:px-4 py-1.5 xl:py-2 absolute inset-0 z-10 bg-transparent transition-colors rounded-xl",
                        isActive
                          ? "text-foreground"
                          : "text-muted-foreground group-hover:text-foreground",
                      )}
